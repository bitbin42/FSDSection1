...
namespace TeachersUpdate {
  public class ConsoleTeachersUpdate : IMainApp, IDisposable {

  private readonly ConsoleColor INFOCOLOR=ConsoleColor.Blue;
  private readonly ConsoleColor PROMPTCOLOR=ConsoleColor.Green;
  private readonly ConsoleColor DATACOLOR=ConsoleColor.Yellow;
  ...
  /// </summary>
  private IFaculty moFaculty=null;
  ...
  private void DeleteTeacher(string Request) {
  ...
  private void AddTeacher(string Request) {
  if (Request.Length>0) {
    string[] sParts=Request.Split(new char[]{' '},StringSplitOptions.RemoveEmptyEntries);
  ...
  private void AddTeacher(string FirstName,string LastName,string Dept) {
  ...
  private void EditTeacher(string Request) {
  ...
  private void ListRecords(string Request) {
  ...
  /// </summary>
  private void SortTeachers(string Request) {
  ...
  private void WriteConsole(string TheText,ConsoleColor TextColor,bool AddCRLF=true) {
